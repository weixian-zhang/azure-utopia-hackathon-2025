...
class PassengerQualificationModel:
    ...
    def extract_features(self, input: str) -> PassengerFeature:
        ...
        fetures to extract with example value:
        Pclass: 1,
        Sex: female,
        Age: 35,
        SibSp: 0,
        ...
        response = llm.invoke([
            ...
            HumanMessage(content=f"Extract the features from this description: {input}")
        ])
    ...
    def preprocess_data(self, df):
        ...
        columns_to_drop = ['PassengerId', 'Name', 'Selected']
...
def main():
    ...
    # Initialize model
    classifier = PassengerQualificationModel(csv_path)
    ...
    print("="*60)
    classifier_lr = PassengerQualificationModel(csv_path)
